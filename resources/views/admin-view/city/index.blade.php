...
<div class="card mb-5 mb-xl-8">
    ...
    <div class="card-header border-0 pt-5">
        ...
        <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"
            ...
            <a href="{{route('add-city')}}" class="btn btn-sm btn-light btn-active-primary">
            ...
            <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="text-dark fw-bold d-block fs-6">{{$cities->city_name}}</span>
                        </td>

                        <td>
                            <span class="text-dark fw-bold d-block fs-6">{{$cities->state->state_name}}</span>
                        </td>

                        <td>
                            <div class="d-flex justify-content-end flex-shrink-0">
                                <a href="{{route('edit-city',[base64_encode($cities['id'])])}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
