...
<div class="card mb-5 mb-xl-8">
    ...
    <div class="card-header border-0 pt-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bold fs-3 mb-1">Menu List</span>
        </h3>

        <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"
            data-bs-original-title="Click to add a user" data-kt-initialized="1">
            <a href="{{route('add-menu')}}" class="btn btn-sm btn-light btn-active-primary">
            ...
            <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                ...
                <thead>
                    <tr class="fw-bold text-muted">
                        ...
                        <th class="min-w-150px">Menu Time</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="text-dark fw-bold d-block fs-6">{{$menus->menu_name}}</span>
                        </td>
                        ...
                        <td>
                            <div class="d-flex justify-content-end flex-shrink-0">
                                <a href="{{route('edit-menu',[base64_encode($menus['id'])])}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
