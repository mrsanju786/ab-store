                            ...
                            <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_role_scroll">
                                ...
                                <div class="fv-row mb-10 fv-plugins-icon-container">
                                    ...
                                    <select class="form-select form-select-solid" aria-label="Select example" name="location_id" data-control="select2">                                        
                                        ...
                                        <option value="{{$locations->id}}" {{($area->location_id == $locations->id) ? 'selected' : ''}}>{{$locations->address}}</option>
                                        @endforeach                                        
                                    </select>
                                    <!--end::Input-->
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="d-flex flex-column scroll-y me-n7 pe-p pe-md-7" id="kt_modal_add_role_scroll">
                                ...
                                <div class="fv-row mb-10 fv-plugins-icon-container">
                                    ...
                                    <!--end::Label-->        
                                    <!--begin::Input-->
                                    <input class="form-control form-control-solid" placeholder="Enter Area name" name="area_name" value="{{$area->area_name}}">
                                    <!--end::Input-->
