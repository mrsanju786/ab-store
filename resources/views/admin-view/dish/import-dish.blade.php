            ...
            <div class="col-md-12 mx-auto">
                <div class="card card-flush h-md-100" id="kt_modal_add_role">
                    ...
                    <div class="card-body pt-1">
                        <!--begin::Form-->
                        <form action="{{route('import-dish')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="fv-row mb-10 fv-plugins-icon-container">
                                    ...
                                    <!--begin::Input-->
                                    <input type="file" class="form-control form-control-solid" placeholder="Enter Branch Name"
                                        name="file">
                                    <!--end::Input-->
                                    @if($errors->has('file'))
