            ...
            <div class="container">
                <div class="row justify-content-center login_area">
                    <div class="col-md-4 login_page_form">
                        ...
                        <form class="loginuser" action="{{url('admin/save-register')}}" method="POST" id="logForm">
                        @csrf
                            <div class="form-group">
                                <input type="name" class="form-control form-control-user" id="name" name="name"  placeholder="Enter Your Name">
                                    @if ($errors->has('name'))
                            ...
                            <button class="btn btn-block login_btn" type="submit">Register</button>
                        </form>
