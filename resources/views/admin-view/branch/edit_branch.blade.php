                            ...
                            <div class="d-flex flex-column scroll-y me-n7 pe-p pe-md-7" id="kt_modal_add_role_scroll">
                                ...
                                <div class="fv-row mb-10 fv-plugins-icon-container">
                                    ...
                                    <select class="form-select form-select-solid" aria-label="Select example" name="discount_id" id="discount_id" data-control="select2">
                                        ...
                                        <option value="{{$discounts->id}}" {{($branch->discount_ids == $discounts->id)? 'selected':''}}>{{$discounts->discount_name}}</option>
                                        @endforeach
    ...
    $("#tax_id").append('<option value="">Select Tax</option>');
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                {
                    $('#tax_id option[value='+value+']').attr('selected','selected');
                });
