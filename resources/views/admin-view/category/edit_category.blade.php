                            ...
                            <input type="hidden" name="category_id" id="category_id" value="{{$category->id}}">
                                ...
                                <div class="fv-row mb-10 fv-plugins-icon-container">
                                    ...
                                    <select class="form-select form-select-solid" aria-label="Select example" name="branch_id" id="branch_id" data-control="select2" >
                                            ...
                                            <option value="{{$branchs->id}}" {{($branchs->id == $category->branch_id)?'selected':''}}>{{$branchs->name}}</option>
                                            @endforeach                                   
                                        </select>
                                    <!--end::Input-->
                                ...
                                <div class="fv-row mb-10 fv-plugins-icon-container">
                                    ...
                                    <select class="form-select form-select-solid" aria-label="Select example" name="counter_id" id="counter_id" data-control="select2" >
                                            ...
                                            <option value="{{$counters->id}}" {{($counters->id == $category->counter_id)?'selected':''}}>{{$counters->counter_name}}</option>
                                            @endforeach                                   
                                        </select>
                                    <!--end::Input-->
                                ...
                                <div class="fv-row mb-10 fv-plugins-icon-container">
                                    ...
                                    <!--begin::Input-->
                                    <input class="form-check-input" name="item_type" type="radio" value="0" {{($category->item_type == "0")? 'checked':''}}>
                                        <span class="fw-semibold ps-2 fs-6">
                                        Live
                                        </span>

                                    <input class="form-check-input" name="item_type" type="radio" value="1" {{($category->item_type == "1")? 'checked':''}}>
                                        <span class="fw-semibold ps-2 fs-6">
                                        Ready to go
                                        </span>
                                    <!--end::Input-->
                                ...
                                <div class="fv-row mb-10 fv-plugins-icon-container">
                                    ...
                                    <input class="form-check-input" name="menu_id[]" type="checkbox" value="{{$menus->id}}" {{(in_array($menus->id, $category_has_menu))?'checked':''}}>
                                    <span class="fw-semibold ps-2 fs-6">
                                    {{$menus->menu_name}}
                                    </span>
                                    </label>
                                ...
                                <div class="fv-row mb-10 fv-plugins-icon-container">
                                    ...
                                    <select class="form-select form-select-solid" aria-label="Select example" name="category_type" id="category_type" data-control="select2" >
                                            ...
                                            <option value="Non-Veg" {{($category->category_type == 'Non-Veg')?'selected':''}}>Non-Veg</option>
                                            <option value="Beverages" {{($category->category_type == 'Beverages')?'selected':''}}>Beverages</option>
                                        </select>
                                    <!--end::Input-->
