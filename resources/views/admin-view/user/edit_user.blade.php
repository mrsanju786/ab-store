                            ...
                            <input type="hidden" name="user_id" value="{{$user->id}}">
                                ...
                                <div class="fv-row mb-10 fv-plugins-icon-container">
                                    ...
                                    <select class="form-select form-select-solid" aria-label="Select example" name="role" id="role" data-control="select2" >
                                            ...
                                            <option value="{{$roles->name}}" {{($roles->name == $user->getRoleNames()[0])?'selected':''}}>{{$roles->name}}</option>
                                            @endforeach                                   
                                        </select>
                                    <!--end::Input-->
                                    @if($errors->has('role'))
                                ...
                                <div class="fv-row mb-10 fv-plugins-icon-container">
                                    ...
                                    <select class="form-select form-select-solid" aria-label="Select example" name="company_id" id="company_id" data-control="select2" >
                                            ...
                                            <option value="{{$companies->id}}" {{($companies->id == $company_id)? 'selected':''}}>{{$companies->company_name}}</option>
                                            @endforeach                                   
                                        </select>
                                    <!--end::Input-->
                                    @if($errors->has('role'))
