    ...
    <div class="col-md-12 mx-auto">
        <div class="card card-flush h-md-100" id="kt_modal_add_role">
            ...
            <div class="card-body">
                ...
                <!--begin::Form-->
                <form action="{{route('create-discount')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_role_scroll">
                                ...
                                <div class="fv-row mb-10 fv-plugins-icon-container">
                                    ...
                                    <!--begin::Input-->
                                    <input class="form-control form-control-solid" placeholder="Discount Name" name="discount_name">
                                    <!--end::Input-->
                                ...
                                <div class="fv-row mb-10 fv-plugins-icon-container">
                                    <!--begin::Label-->
                                    <label class="fs-5 fw-bold form-label mb-2">
                                        <span class="required">Discont Percent</span>
                                    </label>
                                    <!--end::Label-->

                                    <!--begin::Input-->
                                    <input type="number" class="form-control form-control-solid" placeholder="Discont Percent"
