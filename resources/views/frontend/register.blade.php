            ...
            <div class="tp-login-option">
                ...
                <div class="tp-login-input-wrapper">
                    <div class="tp-login-input-box">
                        ...
                        <input id="name" type="text" placeholder="Enter First Name" name="first_name">
                    ...
                    <div class="tp-login-input-box">
                        <div class="tp-login-input">
                        <input id="name" type="text" placeholder="Enter Last Name" name="last_name">
                    ...
                    <div class="tp-login-input-box">
                        <div class="tp-login-input">
                        <input id="tp_password" type="password" placeholder="Enter Password" name="password">
