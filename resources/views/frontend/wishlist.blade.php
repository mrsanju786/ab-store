...
<div class="row">
    <div class="col-xl-12">
        ...
        <table class="table">
            ...
            <tbody>
                @if(!empty($wihslistProduct))
                @foreach($wihslistProduct as $wishlist)
                <tr>
                    <!-- img -->
                    <td class="tp-cart-img"><a href="{{url('/product-detail')}}/{{base64_encode($wishlist->product_id)}}"> 
                    <img src="{{env('APP_URL')."product"}}/{{$wishlist->productColor->color_product_image}}" alt=""></a></td>
                    <!-- title -->
                    ...
                    <a href="{{route('wishlistToCart')}}/{{$wishlist->product_id}}" class="tp-btn tp-btn-2 tp-btn-blue">Add To Cart</a>
                    </td>
                    
                    <!-- action -->
                    <td class="tp-cart-action">
                    <a class="tp-cart-action-btn" href="{{url('delete-product')}}/{{$wishlist->id}}">
                        <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
