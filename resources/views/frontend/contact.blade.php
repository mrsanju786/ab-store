                                 ...
                                 <div class="tp-contact-input-wrapper">
                                    <div class="tp-contact-input-box">
                                       ...
                                       <div class="tp-contact-input">
                                          <input name="name"  type="text" placeholder="Shahnewaz Sakil">
                                          @if ($errors->has('name'))
                                    ...
                                    <div class="tp-contact-input-box">
                                       <div class="tp-contact-input">
                                          <input name="email"  type="email" placeholder="shofy@mail.com">
                                          @if ($errors->has('email'))
                        ...
                        <div class="tp-contact-info-wrapper">
                           <div class="tp-contact-info-item">
                              ...
                              <div class="tp-contact-info-content">
                                 <p data-info="mail"><a href="mailto:contact@ab.com">contact@ab.com</a></p>
                                 <p data-info="phone"><a href="tel:+(91) 8238899162">+(91) 8238899162</a></p>
                              </div>
                           </div>
                           <div class="tp-contact-info-item">
                              <div class="tp-contact-info-icon">
