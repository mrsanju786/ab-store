               ...
               <div class="row align-items-center">
                  <div class="col-xl-5 col-lg-6 col-md-6">
                     <div class="tp-slider-content p-relative z-index-1">
                        ...
                        <h3 class="tp-slider-title">{{$value->title ?? ""}}</h3>
                        <!-- <p>Exclusive offer 
                           <span>-35% 
                  ...
                  <div class="col-xl-7 col-lg-6 col-md-6">
                     <div class="tp-slider-thumb text-end">
                        <img src="{{env('APP_URL')."banner"}}/{{$value->image}}" alt="slider-img">
                     </div>
                  </div>
               </div>
            </div>
      ...
      <div class="row row-cols-lg-5 row-cols-md-3 row-cols-sm-2 row-cols-1">
         <div class="col">
            <div class="tp-instagram-item p-relative z-index-1 fix mb-30 w-img">
               <img src="{{asset('frontend/assets/img/instagram/instagram-1.jpg')}}" alt="">
               <div class="tp-instagram-icon">
                  <a href="{{asset('frontend/assets/img/instagram/instagram-1.jpg')}}" class="popup-image"><i class="fa-brands fa-instagram"></i></a>
               </div>
            </div>
         </div>
         <div class="col">
            <div class="tp-instagram-item p-relative z-index-1 fix mb-30 w-img">
               <img src="{{asset('frontend/assets/img/instagram/instagram-2.jpg')}}" alt="">
               <div class="tp-instagram-icon">
                  <a href="{{asset('frontend/assets/img/instagram/instagram-2.jpg')}}" class="popup-image"><i class="fa-brands fa-instagram"></i></a>
               </div>
            </div>
         </div>
         <div class="col">
            <div class="tp-instagram-item p-relative z-index-1 fix mb-30 w-img">
               <img src="{{asset('frontend/assets/img/instagram/instagram-3.jpg')}}" alt="">
               <div class="tp-instagram-icon">
                  <a href="{{asset('frontend/assets/img/instagram/instagram-3.jpg')}}" class="popup-image"><i class="fa-brands fa-instagram"></i></a>
               </div>
            </div>
         </div>
         <div class="col">
            <div class="tp-instagram-item p-relative z-index-1 fix mb-30 w-img">
               <img src="{{asset('frontend/assets/img/instagram/instagram-4.jpg')}}" alt="">
               <div class="tp-instagram-icon">
                  <a href="{{asset('frontend/assets/img/instagram/instagram-4.jpg')}}" class="popup-image"><i class="fa-brands fa-instagram"></i></a>
               </div>
            </div>
         </div>
         <div class="col">
            <div class="tp-instagram-item p-relative z-index-1 fix mb-30 w-img">
               <img src="{{asset('frontend/assets/img/instagram/instagram-5.jpg')}}" alt="">
               <div class="tp-instagram-icon">
                  <a href="{{asset('frontend/assets/img/instagram/instagram-5.jpg')}}" class="popup-image"><i class="fa-brands fa-instagram"></i></a>
               </div>
            </div>
         </div>
      </div>
