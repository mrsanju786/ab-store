               ...
               <div class="container">
                  <div class="row align-items-center">
                     ...
                     <div class="tp-header-action d-flex align-items-center justify-content-end ml-50">
                           @php
                           if(Auth::check()){
                              $wish_cnt = \App\Models\Wishlist::where('user_id',Auth::user()->id)->count();
                        ...
                        <div class="tp-header-action-item d-none d-lg-block">
                           <a href="{{ url('/wishlist') }}" class="tp-header-action-btn">
                              ...
                              <span class="tp-header-action-badge" id ="wish_cnt">{{$wish_cnt}}</span>                          
                           </a>
                        </div>
                       
                           @php
                           if(Auth::check()){
                              $cart_cnt = \App\Models\Cart::where('user_id',Auth::user()->id)->count();
                        ...
                        <div class="tp-header-action-item">
                           <button type="button" class="tp-header-action-btn cartmini-open-btn">
                              ...
                              <span class="tp-header-action-badge" id="cart_count">{{$cart_cnt}}</span>                                                                          
                           </button>
                        </div>
                                      ...
                                      <a href="shop.html" class="has-mega-menu">
                                         ...
                                         <ul class="mega-menu tp-submenu">
                                            <li>
                                               ...
                                               <ul>
                                                  <li>
                                                     <a href="shop.html"><img src="{{asset('frontend/assets/img/header/menu/menu-1.jpg')}}" alt=""></a>
                                                  </li>
                                                  <li>
                                            ...
                                            <li>
                                               ...
                                               <ul>
                                                  <li>
                                                   <a href="shop.html"><img src="{{asset('frontend/assets/img/header/menu/menu-2.jpg')}}" alt=""></a>
                                                  </li>
                                                  <li>
                                            ...
                                            <li>
                                               ...
                                               <ul>
                                                  <li>
                                                   <a href="shop.html"><img src="{{asset('frontend/assets/img/header/menu/menu-3.jpg')}}" alt=""></a>
                                                  </li>
                                                  <li>
                                          ...
                                          <div class="row row-cols-1 row-cols-lg-4 row-cols-xl-5">
                                                ...
                                                <div class="home-menu-item ">
                                                   <a href="index.html">
                                                      <div class="home-menu-thumb p-relative fix">
                                                         <img src="{{asset('frontend/assets/img/menu/menu-home-1.jpg')}}" alt="">
                                                      </div>
                                             ...
                                             <div class="col">
                                                <div class="home-menu-item ">
                                                   <a href="index-2.html">
                                                      <div class="home-menu-thumb p-relative fix">
                                                         <img src="{{asset('frontend/assets/img/menu/menu-home-2.jpg')}}" alt="">
                                                      </div>
                                                      <div class="home-menu-content">
                                             ...
                                             <div class="col">
                                                <div class="home-menu-item ">
                                                   <a href="index-3.html">
                                                      <div class="home-menu-thumb p-relative fix">
                                                         <img src="{{asset('frontend/assets/img/menu/menu-home-3.jpg')}}" alt="">
                                                      </div>
                                                      <div class="home-menu-content">
                                             ...
                                             <div class="col">
                                                <div class="home-menu-item ">
                                                   <a href="index-4.html">
                                                      <div class="home-menu-thumb p-relative fix">
                                                         <img src="{{asset('frontend/assets/img/menu/menu-home-4.jpg')}}" alt="">
                                                      </div>
                                                      <div class="home-menu-content">
                                             ...
                                             <div class="col">
                                                <div class="home-menu-item ">
                                                   <a href="index-5.html">
                                                      <div class="home-menu-thumb p-relative fix">
                                                         <img src="{{asset('frontend/assets/img/menu/menu-home-5.jpg')}}" alt="">
                                                      </div>
                                                      <div class="home-menu-content">
                                          ...
                                          <div class="row">
                                             ...
                                             <div class="col-lg-3">
                                                <div class="shop-mega-menu-img">
                                                   <img src="{{asset('frontend/assets/img/menu/product/menu-product-img-1.jpg')}}" alt="">
                                             ...
                                             <div class="col-lg-3">
                                                <div class="shop-mega-menu-img">
                                                   <img src="{{asset('frontend/assets/img/menu/product/menu-product-img-2.jpg')}}" alt="">
                                                   <div class="shop-mega-menu-btn">
