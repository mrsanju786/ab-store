                  ...
                  <div class="row">
                     ...
                     <div class="col-xl-5 col-lg-6">
                        <div class="tp-product-details-wrapper">
                           ...
                           <!-- price -->
                           @if(!empty($productDetail['productSize']))
                           <div class="tp-product-details-price-wrapper mb-20">
                              <span class="tp-product-details-price old-price">${{number_format(($productDetail['productSize']['actual_price']),2) ?? "-"}}</span>
                              <span class="tp-product-details-price new-price">${{number_format(($productDetail['productSize']['actual_price']-$productDetail['productSize']['offer_price']),2) ?? "-"}}</span>
                           </div>
                           @endif
                              ...
                              <div class="tp-product-details-variation-item">
                                 ...
                                 <div class="tp-product-details-variation-list">
                                   <?php $colors = DB::table('product_color_variants')->where('product_id',$productDetail->id)->where('status',1)->get(); ?>
                                    ...
                                    <button type="button" class="color tp-color-variation-btn" onclick="changeStyle('{{$color->color_code}}',{{$color->id}})" style="border-color:{{$color->color_code}}; border-radius: 50%; background-color: {{$color->color_code}}; ">
                           ...
                           <!-- actions -->
                           <input type="hidden" id="variant-color" name="variant_color" value="">
                           <input type="hidden" id="variant-size" name="variant_size" value="64">
                           <input type="hidden" id="product-id" name="product_id" value="{{$productDetail->id}}">
                           @if(Auth::check())
...
<script>
    ...
    $(".add_to_cart").click(function(){
        ...
        var variant_color = $("#variant-color").val();
        var variant_size          = $("#variant-size").val();
