                        ...
                        <div class="tab-content" id="profile-tabContent">
                                       ...
                                       <div class="col-md-6">
                                          <div class="profile__main-inner d-flex flex-wrap align-items-center">
                                             <div class="profile__main-thumb">
                                                <img src="{{asset('frontend/assets/img/users/user-10.jpg')}}" alt="">
                                             ...
                                             <div class="profile__main-content">
                                                <h4 class="profile__main-title">Welcome Mr. {{Auth::user()->first_name.' '.Auth::user()->last_name ?? ""}}</h4>
                           ...
                           <div class="tab-pane fade" id="nav-information" role="tabpanel" aria-labelledby="nav-information-tab">
                              <div class="profile__info">
                                 ...
                                 <div class="profile__info-content">
                                    <form action="{{url('/profile-update')}}/{{base64_encode(Auth::user()->id)}}" method="POST">
                                       @csrf
                                       <div class="row">
                                          <div class="col-xxl-6 col-md-6">
                                             <div class="profile__input-box">
                                                <div class="profile__input">
                                                   <input type="text" placeholder="Enter your first name" value="{{Auth::user()->first_name}}" name="first_name">
                                          ...
                                          <div class="col-xxl-6 col-md-6">
                                             <div class="profile__input-box">
                                                <div class="profile__input">
                                                   <input type="text" placeholder="Enter your last name" value="{{Auth::user()->last_name}}" name="last_name">
                                          ...
                                          <div class="col-xxl-6 col-md-6">
                                             <div class="profile__input-box">
                                                <div class="profile__input">
                                                   <input type="email" placeholder="Enter your email"  value="{{Auth::user()->email}}" name="email">
                                          ...
                                          <div class="col-xxl-6 col-md-6">
                                             <div class="profile__input-box">
                                                <div class="profile__input">
                                                   <input type="text" placeholder="Enter your phone number" value="{{Auth::user()->phone}}" name="phone">
                           ...
                           <div class="tab-pane fade" id="nav-password" role="tabpanel" aria-labelledby="nav-password-tab">
                              <div class="profile__password">
                                 <form action="{{url('/changed-password')}}/{{base64_encode(Auth::user()->id)}}" method="POST">
                                 @csrf
                                    <div class="row">
                                       <!-- <div class="col-xxl-12">
                                       ...
                                       <div class="col-xxl-6 col-md-6">
                                          <div class="tp-profile-input-box">
                                             <div class="tp-profile-input">
                                                <input name="password" id="new_pass" type="password">
                                       ...
                                       <div class="col-xxl-6 col-md-6">
                                          <div class="tp-profile-input-box">
                                             <div class="tp-profile-input">
                                                <input name="confirm_password" id="con_new_pass" type="password">
                           ...
                           <?php $allorders = App\Models\Order::where('user_id',Auth::user()->id)->orderBy('id','desc')->get();?>
                                    ...
                                    <tbody>
                                      @if(!empty($allorders))
                                       ...
                                       @foreach($allorders as $key =>$order)
                                          ...
                                          <tr>
                                             <td scope="row">{{$i+1}}</td>
                                             <td data-info="title"><a href="{{url('/order-detail')}}/{{base64_encode($order->id)}}">{{$order->unique_no ?? "-"}}</a></td>
                                             <td data-info="title">{{$order->date ?? "-"}}</td>
                                             <td data-info="title">{{$order->delivery_date ?? "-"}}</td>
                                             <td data-info="title">{{$order->order_amount ?? "-"}}</td>
                                             <td data-info="status pending">Pending</a></td>
                                          </tr>
                                       @endforeach
                                        @endif
                                    </tbody>
