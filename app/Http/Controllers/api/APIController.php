...
class APIController extends Controller
{
    ...
    public function AreaList(Request $request){
        try {
            ...
            $locationList = Area::join('locations','locations.id','=','areas.location_id')
            ...
            return response()->json(['message'=>'Area List!','image_url'=>'','status'=>true,'data'=>$locationList]);                
        }catch (\Exception $e) {
            return response()->json(['errors' => $e], 403);
        }
    ...
    public function categoryList(Request $request){
        try {
            ...
            $categoryList = Category::whereIn('id',$categoryId)->where('is_active',1)->orderBy('id','desc')->get();
    ...
    public function dishList(Request $request){
        try {
            ...
            $dishList = Dish::where('category_id',$category_id)->where('is_active',1)->orderBy('id','desc')->get();
